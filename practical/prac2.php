<?php
    /*
    1) You can have double quote inside the single quotes
    2) You can print multiple lines with one single echo statement.
    */
    
    echo 'Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots 
